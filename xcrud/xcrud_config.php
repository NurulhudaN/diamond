...
{
    // default connection
    public static $dbname = 'diamond'; // Your database name
    ...
    public static $autoclean_timeout = 300; // in seconds. Do not change, if not sure. Xcrud clears old instances in session when you reload browser tab or open new tab with xcrud. In this case Xcrud can't work in two tabs in the same time. You can increase timeout on your risk.
